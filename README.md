...
[![crates.io](https://img.shields.io/crates/v/anyinput-core.svg?flat&color=fc8d62&logo=rust")](https://crates.io/crates/anyinput-core)
...
```toml
[dependencies]
anyinput = { version = "0.1.5", features = ["ndarray"] }
```
